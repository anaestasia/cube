...
export default function Home( { onSubmit, connected, onChange }) {
  ...
  return (
    <Container className="accueil-container">
      ...
      <Row className="logo-container">
        <Col xl={12}><img src="/img/logo/logo_ressources_relationnelles_transparent.png" className="App-logo-menu" alt="logo" /></Col>
      </Row>
